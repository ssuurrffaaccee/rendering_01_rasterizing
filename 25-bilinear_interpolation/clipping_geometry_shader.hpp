...
class ClippingTriangleGeometryShader_6 : public GeometryShader {
 public:
  ClippingTriangleGeometryShader_6() {}
  std::vector<VertexStageData> process(const VertexStageData &v_0,
                                       const VertexStageData &v_1,
                                       const VertexStageData &v_2) override {
    Square4 &model_transform = *(Square4 *)get_global_data(0);
...
class ClippingTriangleGeometryShader_7 : public GeometryShader {
 public:
  ClippingTriangleGeometryShader_7() {}
  std::vector<VertexStageData> process(const VertexStageData &v_0,
                                       const VertexStageData &v_1,
                                       const VertexStageData &v_2) override {
    Square4 &model_transform = *(Square4 *)get_global_data(0);
...
REGISTER_SHADER(geometry, GeometryShader, clipping_triangle,
                ClippingTriangleGeometryShader)
REGISTER_SHADER(geometry, GeometryShader, clipping_triangle_6,
                ClippingTriangleGeometryShader_6)
REGISTER_SHADER(geometry, GeometryShader, clipping_triangle_7,
                ClippingTriangleGeometryShader_7)
