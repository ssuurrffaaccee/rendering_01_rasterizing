...
int main() {
  try {
    ...
    //       Instance{"uv_sphere", Vec3{0.0f, 0.0f, 0.0f},
    //       Vec3{4.0f, 4.0f, 4.0f},
    //                eye<float, 3>(), false};
    ...
    }
    {
      Square3 rotate{0.3333333,  -0.2440169, 0.9106836, 0.9106836, 0.3333333,
                     -0.2440169, -0.2440169, 0.9106836, 0.3333333};
      auto figure_texture = make_bilinear_image_texture("../crate-texture.jpg");
      // auto figure_texture = make_check_texture();
      auto uv_cube_instance = Instance{"uv_cube", Vec3{-1.5f, 0.0f, 0.0f},
                                       Vec3{1.0f, 1.0f, 1.0f}, rotate, false};
      uv_blinn_phong_renader_homoposition_uv_norm(renderer.get(), camera, image,
                                                  model_pool, uv_cube_instance,
                                                  lights, figure_texture);
