...
int main() {
  try {
    ...
    {
      auto image_texture = make_image_texture("../brickwall.jpg");
      ...
      // geometry pass
      {
        ...
        uv_deferred_geometry_rendering_homoposition_uv_norm(
            ...
            uv_cube_instance, image_texture);
      }
      // geometry pass
      {
        auto uv_cube_instance = Instance{"uv_cube", Vec3{1.6f, 0.0f, 0.0f},
      ...
      //just dump it :(
      g_buffer_image.dump("xxx_color",0);
      g_buffer_image.dump("xxx_norm",3);
      g_buffer_image.dump("xxx_position",6);
      // light pass
      uv_deferred_lights_rendering(renderer.get(), camera, image, model_pool,
