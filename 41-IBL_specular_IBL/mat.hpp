...
#include "vec.hpp"
template <typename Type, size_t Len> using Square = std::array<Type, Len * Len>;
...
template <typename Type, size_t Len> Vec<Type, Len * Len> eye() {
...
Square4 adjugate4(const Square4 &m4) {
#define REF(m, x, y, len) (m.begin() + x * len + y)
#define ONE(y, x, x0, x1, x2, y0, y1, y2)                                      \
  *REF(res, x, y, len) = (1 - ((x + y) % 2) * 2) * determinant3(Square3{       \
                                                       *REF(m4, x0, y0, len),  \
                                                       *REF(m4, x0, y1, len),  \
                                                       *REF(m4, x0, y2, len),  \
                                                       *REF(m4, x1, y0, len),  \
...
float determinant4(const Square4 &m4) {
#define REF(m, x, y, len) (m.begin() + x * len + y)
#define ONE(x, y, x0, x1, x2, y0, y1, y2)                                      \
  res += (1 - ((x + y) % 2) * 2) * *REF(m4, x, y, len) *                       \
         determinant3(Square3{                                                 \
             *REF(m4, x0, y0, len),                                            \
             *REF(m4, x0, y1, len),                                            \
             *REF(m4, x0, y2, len),                                            \
             *REF(m4, x1, y0, len),                                            \
...
Square4 inverse4(const Square4 &m4) { return adjugate4(m4) / determinant4(m4); }
