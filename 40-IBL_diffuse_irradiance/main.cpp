...
int main() {
  try {
    ...
    {
      auto cube_map_texture =
          convert_hdr_equidistant_cylindrical_to_cube_mapping(
          ...
          renderer.get(), model_pool, cube_map_texture);
      {
        ...
        lights.push_back(make_ibl_diffuse_pbr_ambient_light());
        lights.push_back(
        ...
        auto metallic_texture = make_scale_image_texture(
            "../../resources/textures/" + material_type + "/metallic.png",
            scale);
        ...
        auto roughness_texture = make_scale_image_texture(
            "../../resources/textures/" + material_type + "/roughness.png",
            scale);
        ...
        ibl_diffuse_pbr_uv_deferred_lights_rendering(
            renderer.get(), camera, image, model_pool, lights, g_buffer_image,
            diffuse_cube_texture);
