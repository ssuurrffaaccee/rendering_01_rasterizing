...
struct ColorDepthProperty {
  float depth_;
  Color color_;
};

ColorDepthProperty mix(const ColorDepthProperty &r, const ColorDepthProperty &l,
                       float &ratio) {
  ColorDepthProperty res;
  res.depth_ = ::mix(r.depth_, l.depth_, ratio);
